...
public abstract class AbstractInvoker implements ObjectInvoker {
	...
	public abstract Object invokeImpl(Object proxy, Method method, Object[] args) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException;
}
